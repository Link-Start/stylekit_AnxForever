...
export const metadata: Metadata = {
  title: "Color Palettes & Hex Codes for 130+ Design Styles",
  description:
    "Search and copy hex codes from 130+ curated design styles — Glassmorphism, Bauhaus, Cyberpunk, and more. Every color tagged with its style, ready for Tailwind, CSS, and AI prompts.",
  keywords: [
    "color palette",
    "hex codes",
    "design style colors",
